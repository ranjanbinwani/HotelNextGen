...
<div class="row">
  ...
  <div class="col-md-6">
    <div style="border-top: 1px solid #f8f8f8; border: 1px solid rgba(0,0,0,0.2); width:500px; height:550px; margin-top:60px; margin-left:30px;">
<form action="AddRoom" method="post">
  <div class="form-group">
    <label for="exampleFormControlInput1">Hotel Name</label>
    <input type="text" class="form-control" name="hotelName" value="<%= hName%>" readonly>
...
while (rslt.next()) {%>
  ...
  <div class="col-md-6">
   ...
   <div class="col-md-12"> 
<div class="caption" style="border-top: 1px solid #f8f8f8; border: 1px solid rgba(0,0,0,0.2); width:300px;">
